...
import com.learnateso.learn_ateso.AppCompatPreferenceActivity;
...
/*
        // Add 'Font Size' preferences, and a corresponding header.
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_font_size);
        getPreferenceScreen().addPreference(fakeHeader);
